  ...
  const mscers = [
    {
      ...
      successStory:
        "Kiến thức và kỹ năng được hệ thống hóa tại các trung tâm đào tạo đã trở thành nền tảng vững chắc, giúp tôi tự tin sáng lập và điều hành hiệu quả nhiều doanh nghiệp.",
    ...
    },
    {
      ...
      successStory:
        "MSC đã trang bị cho tôi nền tảng kỹ thuật vững chắc và soft skills cần thiết để phát triển sự nghiệp trong lĩnh vực công nghệ.",
    ...
    },
    {
      ...
      successStory:
        "Kiến thức về quản trị và phân tích dữ liệu từ MSC giúp tôi hiểu sâu về user behavior và xây dựng sản phẩm thành công.",
    ...
    },
    {
      ...
      successStory:
        "MSC không chỉ dạy kiến thức mà còn rèn luyện tư duy chiến lược, giúp tôi dẫn dắt các chiến dịch marketing quy mô lớn.",
      skills: [
        "Digital Marketing",
        "Brand Strategy",
        "Analytics",
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-msc-primary font-semibold text-sm">
                          {mscer.title}
                        </p>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Tham gia các chương trình đào tạo của MSC Center để viết nên câu
              chuyện thành công của riêng bạn
            </p>
