...
import { ArrowRight, Users, Target, BookOpen, Award, TrendingUp, Globe } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Chương trình đào tạo được thiết kế bởi các chuyên gia hàng đầu trong ngành",
      icon: BookOpen,
      color: "bg-blue-500",
    },
    {
      title: "Mentor 1-1",
      description: "Được hướng dẫn trực tiếp bởi những mentor có kinh nghiệm thực tế",
      icon: Users,
      color: "bg-green-500",
    },
    {
      title: "Dự án Thực tế",
      description: "Tham gia vào các dự án thực tế để tích lũy kinh nghiệm làm việc",
      icon: Target,
      color: "bg-purple-500",
    },
    {
      title: "Cộng đồng MSCer",
      description: "Kết nối với cộng đồng alumni thành công trong nhiều lĩnh vực",
      icon: Globe,
      color: "bg-orange-500",
    },
  ];
        ...
        <div className="relative z-10 container mx-auto px-4 flex items-center justify-center min-h-screen">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/training">
                <Button size="lg" className="msc-button-primary text-lg px-8 py-4 h-auto">
                  Khám phá khóa học
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Link to="/mentors">
                <Button variant="outline" size="lg" className="msc-button-secondary text-lg px-8 py-4 h-auto">
                  Gặp gỡ Mentors
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="msc-section-title mb-4">
              Tại sao chọn MSC Center?
            </h2>
            <p className="msc-subtitle max-w-2xl mx-auto">
              Chúng tôi cam kết mang đến trải nghiệm học tập tốt nhất với phương pháp giảng dạy hiện đại
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="msc-subtitle max-w-2xl mx-auto">
              Các chương trình đào tạo được thiết kế phù hợp với nhu cầu thị trường
            </p>
          </div>
              ...
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <div className="flex justify-between items-center">
                    ...
                    <Link to="/training">
                      <Button variant="outline" size="sm" className="text-msc-primary border-msc-primary hover:bg-msc-primary hover:text-white">
                        Tìm hiểu thêm
                      </Button>
                    </Link>
                  </div>
      ...
      <section className="py-20 bg-msc-gradient">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register">
              <Button size="lg" variant="secondary" className="bg-white text-msc-primary hover:bg-blue-50 px-8 py-4 h-auto text-lg">
                Đăng ký ngay
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
            <Link to="/contact">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-msc-primary px-8 py-4 h-auto text-lg">
                Liên hệ tư vấn
              </Button>
            </Link>
          </div>
