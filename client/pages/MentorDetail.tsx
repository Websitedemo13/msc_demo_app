      ...
      <main className="pt-20 pb-32">
        ...
        >
          <div className="text-center">
            ...
            >
              <h1 className="text-2xl font-serif font-bold mb-1">{mentor.name}</h1>
              <p className="text-white/90 text-sm font-medium mb-2">{mentor.title}</p>
              <p className="text-white/80 text-xs mb-4 max-w-xs mx-auto">{mentor.subtitle}</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-center">
                <div className="text-lg font-bold mb-1">{mentor.students}</div>
                <span className="text-xs text-white/80">Học viên</span>
              </div>
              <div className="text-center">
                <div className="text-lg font-bold mb-1">{mentor.sessions}</div>
                  ...
                  >
                    <div className="pt-4 space-y-3">
                      <div className="flex justify-between py-2">
                        ...
                        <span className="font-medium text-sm">{mentor.personalInfo.fullName}</span>
                      </div>
                      <div className="flex justify-between py-2">
                        <span className="text-gray-600 text-sm">Học vị</span>
                        <span className="font-medium text-sm">{mentor.personalInfo.degree}</span>
                      </div>
                      <Separator />
            ...
            <div className="p-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Kỹ năng chuyên môn</h3>
                </div>
            ...
            <div className="p-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Tổ chức làm việc</h3>
                </div>
                {expandedSections.positions ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
              </motion.button>
            ...
            <div className="p-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Bằng cấp chuyên môn</h3>
                </div>
                {expandedSections.degrees ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
              </motion.button>
            ...
            <div className="p-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Quá trình công tác</h3>
                </div>
                {expandedSections.workHistory ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
              </motion.button>
                        ...
                        >
                          ...
                          <div className="bg-white p-3 rounded-lg border border-gray-100">
                            <div className="flex flex-col mb-2">
                              <h4 className="font-semibold text-gray-900 text-sm">{work.role}</h4>
                              <p className="text-blue-600 font-medium text-sm">{work.company}</p>
                              <span className="text-xs text-gray-500 mt-1">{work.period}</span>
                            </div>
                          </div>
                        </motion.div>
                      ))}
            ...
            <div className="p-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Thành tích nổi bật</h3>
                </div>
                {expandedSections.achievements ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
              </motion.button>
      ...
      >
        ...
        <div className="text-center mt-2">
          <p className="text-xs text-gray-500">
            Học tập cùng mentor với hơn {mentor.experience.replace(/\D/g, "")} năm kinh nghiệm
          </p>
        </div>
      </motion.div>
    </div>
